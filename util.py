...
class ValueIteration(MDPAlgorithm):
    ...
    def solve(self, mdp, epsilon=0.001):
        ...
        mdp.computeStates()
        print("Compute State Time: ", (time.time() - start_time))
    ...
    def computeStates(self):
        ...
        while len(queue) > 0:
            ...
            for action in self.actions(state):
                ...
                #print("Inner Loop time:" , (time.time() - start_time))
...
def simpleEnroll(bulletin) :
    ...
    quarter = input("What quarter are you entering? (Aut,Win, or Spr): ")
    while(quarter not in validQuarters):
        if(quarter == 'x'):
            sys.exit()
    ...
    validYears= {"1","2","3","4"}
    year = input("What year registering for? (1,2,3 or 4): ")
